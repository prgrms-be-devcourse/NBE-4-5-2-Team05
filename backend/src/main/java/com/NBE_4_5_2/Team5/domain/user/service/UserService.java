...
import com.NBE_4_5_2.Team5.global.exception.validation.AlreadyUsedEmailException;
	...
	public UserDto updateMyProfile(User user, UserUpdateRequest updateRequest) {
		...
		if (updateRequest.getEmail() != null && !updateRequest.getEmail().equals(user.getEmail())) {
			if (userRepository.existsByEmail(updateRequest.getEmail())) {
				throw new AlreadyUsedEmailException("400-EMAIL-ALREADY-EXISTS", "이미 사용 중인 이메일입니다.");
			}
